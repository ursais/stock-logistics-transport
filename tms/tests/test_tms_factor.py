...
class TestTmsFactor(TransactionCase):
    ...
    def test_30_get_amount_distance_real(self):
        ...
        self.assertEqual(value, 200, "Error in factor calculation (distance_real)")
    ...
    def test_31_get_amount_distance_real_range(self):
        ...
        self.assertEqual(value, 1500, "Error in factor calculation (distance_real)")
    ...
    def test_32_get_amount_distance_real_fixed_amount(self):
        ...
        factor.fixed_amount = 100
        value = factor.get_amount(distance_real=100)
        self.assertEqual(value, 300, "Error in factor calculation (distance_real)")
    ...
    def test_40_get_amount_weight(self):
        ...
        self.assertEqual(value, 200, "Error in factor calculation (weight)")
    ...
    def test_41_get_amount_weight_range(self):
        ...
        self.assertEqual(value, 1500, "Error in factor calculation (weight)")
    ...
    def test_42_get_amount_weight_fixed_amount(self):
        ...
        value = factor.get_amount(weight=100)
        self.assertEqual(value, 300, "Error in factor calculation (weight)")
    ...
    def test_50_get_amount_travel(self):
        ...
        self.assertEqual(value, 100, "Error in factor calculation (travel)")
    ...
    def test_60_get_amount_qty(self):
        ...
        self.assertEqual(value, 200, "Error in factor calculation (qty)")
    ...
    def test_61_get_amount_qty_range(self):
        ...
        self.assertEqual(value, 1500, "Error in factor calculation (qty)")
    ...
    def test_62_get_amount_qty_fixed_amount(self):
        ...
        value = factor.get_amount(qty=100)
        self.assertEqual(value, 300, "Error in factor calculation (qty)")
    ...
    def test_70_get_amount_volume(self):
        ...
        self.assertEqual(value, 200, "Error in factor calculation (volume)")
    ...
    def test_71_get_amount_volume_range(self):
        ...
        self.assertEqual(value, 1500, "Error in factor calculation (volume)")
    ...
    def test_72_get_amount_volume_fixed_amount(self):
        ...
        value = factor.get_amount(volume=100)
        self.assertEqual(value, 300, "Error in factor calculation (volume)")
    ...
    def test_80_get_amount_percent(self):
        ...
        self.assertEqual(value, 100, "Error in factor calculation (percent)")
    ...
    def test_81_get_amount_percent_fixed_amount(self):
        ...
        value = factor.get_amount(income=1000)
        self.assertEqual(value, 200, "Error in factor calculation (percent)")

    def test_90_get_driver_amount(self):
        factor = self.create_factor()
        with self.assertRaisesRegex(ValidationError, "The employee must have a income percentage value"):
        ...
        with self.assertRaisesRegex(ValidationError, "Invalid parameter you can use this factor only with drivers"):
    ...
    def test_100_get_amount(self):
        ...
        self.employee.income_percentage = 500
        percent = factor.get_amount(employee=self.employee, income=100)
        self.assertEqual(percent, 500.0, "Error in amount")
        factor.factor_type = "amount_driver"
        factor.fixed_amount = 100.0
        amount = factor.get_amount(employee=self.employee)
        self.assertEqual(amount, 500.0, "Error in amount")
        with self.assertRaisesRegex(ValidationError, "the amount isnt between of any ranges"):
