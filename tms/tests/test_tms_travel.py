...
class TestTmsTravel(TransactionCase):
    def setUp(self):
        ...
        self.operating_unit_id = self.env.ref("operating_unit.main_operating_unit")
    ...
    def test_10_tms_travel_compute_travel_duration(self):
        ...
        self.assertEqual(float_compare(self.travel_id.travel_duration, 240, precision_digits=2), 0)
    ...
    def test_20_tms_travel_compute_travel_duration_real(self):
        ...
        self.assertEqual(float_compare(self.travel_id.travel_duration_real, 240, precision_digits=2), 0)
    ...
    def test_60_tms_travel_action_progress(self):
        ...
        with self.assertRaisesRegex(ValidationError, "The unit or driver are already in use!"):
    ...
    def test_80_tms_travel_create(self):
        ...
        with self.assertRaisesRegex(ValidationError, "You need to define the sequence for travels in base"):
    ...
    def test_110_tms_travel_validate_driver_license(self):
        ...
        with self.assertRaisesRegex(
            ...
            "to expire in next 5 days" % self.travel_id.employee_id.license_expiration,
        ):
    ...
    def test_120_tms_travel_validate_vehicle_insurance(self):
        ...
        with self.assertRaisesRegex(
            ...
            "next 5 days"
            % (self.travel_id.unit_id.name, self.travel_id.unit_id.insurance_expiration.strftime("%Y-%m-%d")),  # noqa
        ):
