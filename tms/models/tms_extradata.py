...
class TmsExtradata(models.Model):
    ...
    type_id = fields.Many2one("tms.extradata.type", string="Type of Data", required="True")
    ...
    @api.onchange("value_char", "value_integer", "value_float", "value_date", "value_datetime", "value_extra")
    ...
    def fields_view_get(self, view_id=None, view_type="form", toolbar=False, submenu=False):
        ...
        res["arch"] = etree.tostring(doc)  # pylint: disable=c-extension-no-member
        return res
