...
class FleetVehicle(models.Model):
    ...
    notes = fields.Text()
    employee_id = fields.Many2one("hr.employee", string="Driver Employee", domain=[("driver", "=", True)])
    ...
    unit_extradata = fields.One2many("tms.extradata", "vehicle_id", string="Extra Data Fields", readonly=False)
    ...
    def _compute_insurance_days_to_expire(self):
        for rec in self:
            ...
            date_expire = rec.insurance_expiration if rec.insurance_expiration else now
