...
class TmsTravel(models.Model):
    ...
    l10n_mx_edi_configuration = fields.Selection(
        selection=[
            ...
            (
                "T2S1R2",
                "Tractocamión Semirremolque-Remolque (6 llantas en el tractocamión, 4 llantas en el "
                "semirremolque y 8 llantas en el remolque)",
            ),
            (
                "T2S2R2",
                "Tractocamión Semirremolque-Remolque (6 llantas en el tractocamión, 8 llantas en el "
                "semirremolque y 8 llantas en el remolque)",
            ),
            (
                "T2S1R3",
            ...
            (
                "T3S1R2",
                "Tractocamión Semirremolque-Remolque (10 llantas en el tractocamión, 4 llantas en el "
                "semirremolque y 8 llantas en el remolque)",
            ),
            (
                "T3S1R3",
            ...
            (
                "T3S2R2",
                "Tractocamión Semirremolque-Remolque (10 llantas en el tractocamión, 8 llantas en el "
                "semirremolque y 8 llantas en el remolque)",
            ),
            (
                "T3S2R3",
            ...
            (
                "T2S2S2",
                "Tractocamión Semirremolque-Semirremolque (6 llantas en el tractocamión, 8 llantas en el "
                "semirremolque delantero y 8 llantas en el semirremolque trasero)",
            ),
            (
                "T3S2S2",
                "Tractocamión Semirremolque-Semirremolque (10 llantas en el tractocamión, 8 llantas en el "
                "semirremolque delantero y 8 llantas en el semirremolque trasero)",
            ),
            (
                "T3S3S2",
                "Tractocamión Semirremolque-Semirremolque (10 llantas en el tractocamión, 12 llantas en el "
                "semirremolque delantero y 8 llantas en el semirremolque trasero)",
            ),
